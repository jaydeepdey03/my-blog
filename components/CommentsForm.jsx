    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4'>
                ...
                <input name='email' placeholder='Email' type="text" ref={emailEl} className="py-2 px-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700" />
            </div>
            {error && <p className='text-xs text-red-500'>All Fields Required</p>}
            <div className='grid grid-cols-1 gap-4 mb-4'>
                <div className='flex space-x-2 items-center'>
                    <input ref={storeDataEl} type="checkbox" id='storeData' name='storeData' value="true" />
                    <label className='text-gray-500 cursor-pointer' htmlFor='storeData'>Save my Name and Email for Next time I comment</label>
                </div>
            </div>
            <div className='mt-8'>
                <button
